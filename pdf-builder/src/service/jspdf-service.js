class JsPdfService {
  ...
  setupVietnameseFont() {
    ...
    try {
      ...
      if (fonts['Roboto']) {
        ...
        console.log('✅ Vietnamese font Roboto loaded successfully');
      } else {
        console.warn('Font Roboto chưa được load, sử dụng font mặc định');
  ...
  renderJustifiedMixedLine(words, startX, y, config) {
    ...
    words.forEach((word, index) => {
      ...
      this.doc.text(cleanText, currentX, y);
      currentX += this.doc.getTextWidth(cleanText);
